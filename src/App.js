...
import Dashboard from './pages/dashboard'; // Updated import path (ensure consistency)
    ...
    <div>
      ...
      <div>
        <Routes>
          ...
          <Route
            path="/users"
            element={isAuthenticated ? <Users users={[]} /> : <Navigate replace to="/login" />}
          />
          <Route
            path="/workouts"
            element={isAuthenticated ? <Workout workouts={[]} /> : <Navigate replace to="/login" />}
          />
